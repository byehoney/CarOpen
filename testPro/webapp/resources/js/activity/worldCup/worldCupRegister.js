/**
 * Created by 29059 on 2018/6/5.
 */
$(function(){
    var tipShow =false;
    var sendflag=false;
    // $(".fri_info p em").html(getUrlParams('mobile'));
...
//    发送短信验证码
    ...
    $(".xyjsp .close_btn").click(function(){
        $(".xyjsp").hide();
        $(".overlay").hide();
    })
    $(".verify .close_btn").click(function(){
        $(".verify").hide();
        $(".overlay").hide();
    })
        ...
        $.post(url, {
            ...
            function(data, varStatus) {
                if (data == 4) {
                    ...
                    window.location.href=basePath + '/worldCup/toRegisterSuccess.do';
                }
            }, "text");
    }
    //短信发送倒计时
