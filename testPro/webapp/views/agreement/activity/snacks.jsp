...
<!-- 					<div class="receive">
	...
	<!-- 					<li>2016-5-27</li>
		...
		<div class="activity_rules">
			<h4>活动规则：</h4>
			<p>1.活动时间:2016年6月30日至2016年7月10日；</p>
			<p>2.参与活动资格：通过本页面注册的用户；</p>
			<p>3.活动期间内，投资满500元（30天以上项目不包含30天），即可领取零食大礼包一份，每个用户仅可领取一份大礼包；</p>
			<p>4.满足礼包资格的用户，再邀请两个好友投资500元（30天及30天以上项目），即可获取趣味存钱罐一个；</p>
			<p>5.礼包将于满足活动条件后的5个工作日内发放；</p>
