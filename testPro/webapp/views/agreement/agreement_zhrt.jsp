...
<div class="body-content">
    ...
    <div class="content">
    	<div class="tkCont">
			<div class="tkCMain">			
<div class="fb_title" style="margin-bottom:65px;">中再融借款协议</div>
...
<div>借款人（抵押人）：xxxx公司 </div>
<div>法定代表人：李磊</div>


<div style="margin-top:20px;">出借人（抵押权人）：</div>
...
<table>
	...
	<tr>
		<th>到期收益率</th><td>12%</td><th>借款期限</th><td>3个月</td>
	</tr>
	<tr>
...
<div class="chapter">二、借款流程</div>
	...
	<p>2.5 借款发放成功为出借人履行资金出借义务完毕的标志，同时也是担保方承担保证责任的起始点。 借款发放成功后，借款人可通过“提现”操作将划转的资金转至其名下的银行账户上。借款人是否执行“提现”操作不影响本协议的效力。 </p>
	...
	<p>4.1 本项目如涉及两人以上借款人，任一借款人均应履行本协议项下的义务，对全部借款承担连带清偿责任，出借人有权向任一借款人追索本项目项下全部应付款项，包括不限于本金、利息、逾期罚息、滞纳金及其他费用。</p>
	...
	<p>5.4 借款人逾期的，借款人尚未清偿的全部剩余本金和收益自逾期之日起按0.6‰/日的利率计收逾期罚息给出借人和按0.54‰/日的利息计算违约金给平台方，直至清偿完应付本金、收益和逾期罚息之日。逾期所产生的收益、逾期罚息不计利息。 </p>
	<div class="chapter">六、抵押担保</div>
	<p>6.1 担保人自愿为本协议的借款向出借人提供抵押担保，抵押担保的范围为本合同项下的本金、收益、逾期罚息和违约金，以及借款人根据协议或适用的中国法律应支付的其他赔偿金和出借人与出借受托人实现债权的费用，包括但不仅限于保全费、诉讼费、律师费、差旅费等。 </p>
	<p>6.2 抵押权人抵押权的效力及于抵押物产生的孳息、抵押物的从物、从权利、附属物、添加物，以及因抵押物的毁损、灭失或被征收、被征用等而产生的保险金、赔偿金、补偿金或其他形式的替代物。 </p>
	<p>6.3 本合同签订后，抵押人和抵押权人应及时到有关登记机关办理抵押登记手续，抵押登记证明在借款人全部还清之前由抵押权人保管；抵押登记事项发生变化依法需要进行变更登记的，抵押人和抵押权应办理变更登记。</p>
	<p>6.4 对于抵押物抵押人需按照抵押权人指定的保险公司和险种进行投保，并以抵押权人作为第一受益人，保险单正本存于抵押权人处，复印件抵押人和监管方各存一份。抵押权人在本合同项下的权益未得到全额清偿前，抵押人不得以任何理由中断或撤销保险；如保险中断或撤销，抵押权人有权代为办理保险手续，相关费用由借款人和抵押人承担。 </p>
	<p>6.5 在本合同履行期间，抵押人的行为足以使抵押物价值减少的，应立即停止其行为；造成抵押物价值减少时，抵押人应及时恢复抵押物的价值，或提供与减少的价值相当的担保。如因市场价格变动，在抵押物总值低于监管最低限额时，抵押权人有权要求抵押人补足抵押物，否则，抵押权人可授权监管方对抵押人的抵押物按法律程序进行变卖或拍卖，所得价款优先用于向抵押权人还款。 </p>
	<p>6.6 抵押人所获得的抵押物的赔偿金、补偿金，保险金以及处分抵押物所得收益，抵押权人有权选择下列方式进行处理：  </p>
	<p class="section">A、提存或提前清偿借款人在本合同项下的债务； </p>
	<p class="section">B、存入抵押权人指定帐户，以担保借款人债务的履行；</p>
	<p class="section">C、双方约定的其他方式。</p>
	<p>6.7 发生下列情形之一，出借人有权自行或委托平台方提前终止本合同并要求借款人立即偿还所有应付本金、收益和违约金，如借款人在出借人或平台方提出要求后3日内未提前偿还，出借人有权委托监管方将抵押物评估、拍卖或变卖，以所得价款优先受偿或按第6.6条约定的其他方式处理；或经与抵押人协商将抵押物折价以抵偿借款人所欠债务；同时保留将借款人违约失信的相关信息在平台或其它媒体披露的权利。  </p>
	...
	<p class="section">D、借款人、担保人及为借款人提供保证担保的担保公司发生任何财产遭受没收、征用、查封、扣押、冻结等可能影响其履约能力的不利事件；</p>
	<p class="section">E、借款人、担保人及为借款人提供保证担保的担保公司的财务状况出现影响其履约能力的不利变化，不能在10日内提供有效补救措施；</p>
	<p class="section">F、出借人受托人或平台方在10日内经过五次以上电话联系借款人，借款人电话一直处于无人接听或关机状态；</p>
	<p class="section">G、在出借人的贷后回访中，借款人不按出借人的要求提供财务资料、合同资料、工商变更文件、涉诉文件等，或不配合出借人对厂房、生产设备、库存、抵押物情况等的检查。</p>
	<p class="section">H、借款人违反本合同约定或法律规定的其他情形。</p>
	<p>6.8 如平台方通过人民法院或当地金融监管部门向借款人发起追偿行为，发起行为的一切费用由平台方先行垫付，平台方有权向借款人追偿因追偿行为所产生、引起或发生的一切费用。 </p>
	<p>6.9 平台方有权就为本协议借款所提供的服务向借款人收取服务费，上述费用的收取方式由借款人和平台方另行约定。 </p>
	<div class="chapter">七、抵押物监管</div>
	<p>7.1 抵押人、抵押权人、监管方三方均同意由监管方对抵押人提供的抵押物进行监管。抵押人需保证抵押物为合法渠道购入的商品，所有权没有任何权利瑕疵，不存在任何权属争议；保证商品质量符合国家相关法律法规规定的产品质量标准，否则由此产生争议与纠纷由抵押人承担全部责任。 </p>
	<p>7.2 监管方应对抵押人的抵押物根据增值税发票进行核对，以进货发票价格及相关市场的公开报价作为抵押物总值计算的基本依据，无发票的库存商品不列入抵押范围。监管方需针对监管的抵押物进行评估，并向出借人提供评估报告。监管方可以根据市场价格对抵押物的总值进行合理调整，且无需经过抵押人的同意，但应及时书面通知抵押权人和抵押人。</p> 
	<p>7.3 在抵押物金额高于监管最低限额时，抵押人经监管方书面同意，可就超出监管最低限额部分的抵押物进行流通使用，如抵押物金额低于监管最低限额时，监管方有权停止抵押人抵押物出库，并要求抵押人限期补足抵押物，同时将前述情形书面告知抵押权人。</p>
	<p>7.4 监管方每月一次向抵押权人提交有关抵押物金额、库存结构、库龄及库存监管情况的报表及报告，并积极配合抵押权人就抵押物及监管方监管情况进行得核查，提供抵押权人要求的资料。</p>
	<p>7.5 在监管期间，若由于监管方原因未按本协议和监管方案的要求履行监管义务造成抵押物损失的，由监管方按照监管最低限额与抵押物实际金额间的差额，向抵押权人承担赔偿责任。</p>
	<p>7.6 由于监管方未尽到监管义务造成抵押物损毁灭失，导致抵押权人发生实际损失的，监管方需根据抵押物损毁灭失或抵押权落空的价值在实际损失范围内对抵押权人承担赔偿责任。</p>
	<p>7.7 抵押人串通监管方损害出借人利益的，由抵押人和监管方对本合同项下的借款本息、费用承担连带赔偿责任。 </p>
	<p>7.8 在借款人未按照本合同约定期限按时足额还款时，抵押权人可授权监管方对抵押人的抵押物按法律程序进行变卖或拍卖，抵押权人有权从所得价款中优先受偿。 </p>
	<p>7.9 发生下列事项时，抵押权人、监管方不承担相应责任，应由甲方承担相应责任与损失： </p>
	<p class="section">a)因货物的自然性质、内在质量瑕疵或缺陷、合理损耗而造成的损失。 </p>
	<p class="section">b)外包装完整，封闭无异状而内件短少、毁损或与标记不一致的。 </p>
	<p class="section">c) 因不可归责于抵押权人、监管方的事故或事件，造成货物的损坏、毁灭、短缺或迟延交货的。</p>
	...
	<p>11.1 出借人在资金出借、债权转让过程产生的相关税收缴纳义务，应由出借人根据中国法律的规定自行向其主管税务机关申报、缴纳，平台方不承担任何代扣代缴的义务及责任，出借人违反上述规定导致平台方承担的任何损失应由出借人负责全额赔偿。 </p>
	...
	<p>11.4 本合同的任何修改、补充均须需经本合同相关各方确认同意，并以平台方平台电子文本形式作出。</p>
