...
<div class="fb_title" style="margin-bottom:65px;">中再融隐私条款</div>
...
<div class="chapter">一、用户身份限制</div>
...
<div class="chapter">二、涉及的个人资料</div>
...
<div class="chapter">三、本网站对您的资料的使用</div>
...
<div class="chapter">四、本网站对您的资料的使用</div>
...
<div class="chapter">五、本网站对您的资料的使用</div>
...
<div class="chapter">六、您对其他用户的资料的使用</div>
<p>在本网站提供的交易活动中，您无权要求本网站提供其他用户的个人资料，除非符合以下条件：</p>
<p class="section">（1）您已向法院起诉其他用户的在本网站活动中的违约行为；</p>
<p class="section">（2）本网站被吊销营业执照、解散、清算、宣告破产或者其他有碍于您收回借款本息的情形。</p>
<div class="chapter">七、电子邮件</div>
