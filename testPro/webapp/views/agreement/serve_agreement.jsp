...
<div class="fb_title" style="margin-bottom:20px;">中再融投资咨询与管理服务电子协议</div>
				
<p>本网站由中再融(北京)科技有限公司负责运营（以下本网站均指网站及中再融(北京)科技有限公司）。在您注册成为本网站用户前请务必仔细阅读以下条款。若您一旦注册，则视为您接受本网站的服务并受以下条款的约束。若您不接受以下条款，请停止注册本网站。</p>
...
<p>您确认本使用协议后，本使用协议即在您和本网站之间产生法律效力。您只要在“我已阅读并且同意中再融的使用协议及隐私条款”前的选择框里打钩并按照本网站规定的注册程序成功注册为用户，您的行为既表示同意并签署了本使用协议。本使用协议不涉及您与本网站的其他用户之间因网上交易而产生的法律关系及法律纠纷，但您在此同意将全面接受和履行与本网站其他用户在本网站签订的任何电子法律文本，并承诺按该法律文本享有和/或放弃相应的权利、承担和/或豁免相应的义务。</p>
<div class="chapter">一、使用限制</div>
...
<p>本网站只接受持有中国大陆、香港特区、澳门特区及台湾地区等有效身份证的18周岁以上的具有完全民事行为能力的自然人成为网站用户。如您不符合资格，请勿注册，否则本网站保留随时中止或终止您用户资格的权利。您在此向本网站保证，您已符合年龄和国籍条件，如因您向本网站提供虚假信息或承诺而导致本网站或中再融(北京)科技有限公司蒙受任何损失，您将承担全部责任并赔偿相关损失。</p>
...
<div class="chapter">二、涉及第三方网站</div>
...
<div class="chapter">八、服务的中止或终止</div>
...
<p class="section">(1)对于网络设备进行必要的保养及施工时；</p>
<p class="section">(2)出现突发性的网络设备故障时；</p>
<p class="section">(3)本网站所使用的网络通信设备由于不明原因停止，无法提供服务时；</p>
<p class="section">(4)由于不可抗力因素致使本网站无法提供线上服务时；</p>
<p class="section">(5)相关政府机构的要求。</p>
<p>3、发生下列情形之一的，本网站有权随时中止或终止向用户提供服务而无需通知用户：</p>
<p class="section">(1)用户提供的个人资料不准确，不真实，不合法有效；</p>
<p class="section">(2)用户使用任何第三方程序进行登录或使用服务；</p>
<p class="section">(3)用户滥用所享受的权利；</p>
<p class="section">(4)用户有损害其他用户的行为；</p>
<p class="section">(5)用户有违背社会风俗和社会道德的行为；</p>
<p class="section">(6)用户有违反本协议中相关规定的行为。</p>
<p>4、如因系统维护或升级的需要而需暂停网络服务，本网站将尽可能事先进行通告。</p>
<p>5、终止用户服务后，用户使用本网站服务的权利立即终止。从终止用户服务即刻起，本网站不再对用户承担任何责任和义务。</p>
<div class="chapter">九、适用法律和管辖</div>
<p>因本网站提供服务所产生的争议均适用中华人民共和国法律，并由中再融(北京)科技有限公司住所地的人民法院管辖。</p>
<div class="chapter">十、附加条款</div>
<p>在本网站的某些部分或页面中、或者您使用本网站相关服务产品的过程中，可能存在除本协议以外的单独的附加服务条款或协议，当这些服务条款或协议与本协议条款及规则存在冲突时，则前述本协议条款和规则以外的服务条款或协议将优先适用。</p>
<div class="chapter">十一、条款的独立性</div>
<p>若本协议的部分条款被认定为无效或者无法实施时，本协议中的其他条款仍然有效。</p>
<div class="chapter">十二、对应账户</div>
...
<div class="chapter">十三、投诉和咨询</div>
<p>若您在使用本网站的过程中有任何的疑问、投诉和咨询，可随时致电客服热线或发送电子邮件到本网站指定的电子邮箱：<a href="mailto:service@zhongzairong.cn">service@zhongzairong.cn</a>。</p>

<p class="sign">中再融</p>
<p class="sign">2015.1.1</p>
