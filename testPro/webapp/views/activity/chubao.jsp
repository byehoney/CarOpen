		...
		<div class="docWrapper">
			...
			<div class="alipayBg">
				...
				<div class="instructions">
					<p>1.   本次活动仅限通过专属链接注册，并完成首次投资，触宝活动奖励于7个工作日发送到用户登录的触宝账户中。</p>
					<p>2. 同一设备，同一IP地址，注册的皆认定为同一用户，任何异常行为，如恶意刷量等，一经发现，中再融有权扣除活动期间该用户所有返利，中再融对本活动拥有最终解释权。 </p>
					<p>3. 本活动最终解释权归于再融(北京)科技有限公司所有。</p>
				</div>
			</div>
