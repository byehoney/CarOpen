...
<div class="deskCalenda_page">
    ...
    <div class="deskCalenda_c">
        <div id="pack3" class="redpacket_two">
            <img src="<%=request.getContextPath()%>/resources/image/activity/weChatTaili/redpacket_two.png" alt="">
            <div class="tips">
                <h3>提示：</h3>
                <%--2-已过期 3,4,5-活动未开始或已结束-活动未开启-活动不存在--%>
                <c:if test="${result.code == 2||result.code == 3||result.code == 4||result.code == 5}">
                    <p>本月福利已过期，下次请及时领取哦~</p>
                </c:if>
                <%--1-未到领取时间--%>
                <c:if test="${result.code == 1}">
                    <p>福利仅限当月领取，改天再来试试吧~</p>
                </c:if>
                <%--  -1-领取失败--%>
                ...
                <%-- 6-本月已领取--%>
                <c:if test="${result.code == 6}">
                    <p>本月福利您已领取</p>
                </c:if>
                <img class="smiling_face" src="<%=request.getContextPath()%>/resources/image/activity/weChatTaili/smiling_face.png" alt="">
            </div>
        </div>
    </div>
    <div class="deskCalenda_b">
        ...
        <div class="download_btn">
            <img id="openApp" src="<%=request.getContextPath()%>/resources/image/activity/weChatTaili/tips_btn.png" alt="">
        </div>
    </div>
</div>
