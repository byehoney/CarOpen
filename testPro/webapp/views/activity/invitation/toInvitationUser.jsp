...
<%
    request.setAttribute("verCode", "?r=Version2018060612");
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/invitation/invitationLoan.css${verCode}">
    <script>
...
<div class="main docWrapper">
    <div class="banner">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_01.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_02.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_03.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_04.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_05.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_06.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_07.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_08.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN//banner_09.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/banner_10.png" alt="">
        <c:if test="${mobile!=null}">
            <div class="invitation_tip">${fn:substring(mobile,0,3)}****${fn:substring(mobile,7,11)}送您<br/><span>999元</span>理财红包，现在输入手机号领取吧~</div>
        </c:if>
    </div>
    <div class="container">
        <div class="alipayBg ali01">
            ...
            <div class="ex_popup"><a id="popup01" href="javascript:;">注册领取999元红包</a></div>
            <div class="go-login">
                已有账号？<a href="<%=request.getContextPath()%>/userInfo/nologin.do">立即登录</a>
            </div>
            <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/optimization_pic.png" alt="">
        </div>
        <div class="items">
            <div class="swiper-container swiperOne">
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper_item swiper_active">
                        <div class="first_shot">新手专享</div>
                        <div class="treasure">
                        ...
                        <div class="plan_cont clearfix">
                            ...
                            <div class="earnings_cont fr">
                                <p>30天</p>
                            </div>
                        </div>
                        <div class="Involved-btn return_top">
        ...
        <img class="register_pic" src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/register_pic.png" alt="">
        <div class="money_title">即投即返，多投多返</div>
        <img class="total_money" src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/total_money.png" alt="">
        <div class="example">
            <p>举个例子</p>
            <div class="cost-list">
                <table class="Payment_detailst">
                    ...
                    <tr>
                        <td>2000</td>
                        <td>30天新手项目</td>
                        <td>19.73+<span>19</span></td>
                    </tr>
                    <tr>
                        <td>2000</td>
                        <td>90天项目</td>
                        <td>44.38+<span>30</span></td>
                    </tr>
                    <tr>
                        <td>10000</td>
                        <td>60天项目</td>
                        <td>115.07+<span>50</span></td>
                    </tr>
                    <tr>
                        <td>10000</td>
                        <td>90天项目</td>
                        <td>221.92+<span>100</span></td>
                    </tr>
                    <tr>
                        <td>50000</td>
                        <td>60天项目</td>
                        <td>575.34+<span>250</span></td>
                    </tr>
                    <tr>
                        <td>50000</td>
                        <td>90天项目</td>
                        <td>1109.59+<span>550</span></td>
                    </tr>
                    </tbody>
                </table>
            </div>
        </div>
        <div class="picList_cont payBg">
            <img class="zzr_pic" src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/zzr_pic.png" alt="">
            <ul class="picList clearfix">
                ...
                <li>
                    <div class="council"></div>
                    <p>全国互联网金融理事会副理事长</p>
                </li>
                <li>
                    <div class="authentication"></div>
                    <p>国家信息安全等级保护三级备案证明</p>
                </li>
                <li>
        ...
        <div class="ex_popup alipayBg  mb">
            <a id="popup02" class="return_top" href="javascript:;">注册领取999元红包</a>
        </div>
...
<!--活动规则弹窗-->
<div class="activity_rule"  style="display:none;">
    <div class="closebtn"></div>
    <img src="<%=request.getContextPath()%>/resources/image/activity/channelPage/newCIBN/activity_rule_pic.png" alt="">
    <ol>
        <li>999元红包可注册后在<a href="javascript:;">“我的红包”</a>中查看，<span>需在红包有效期内使用；</span></li>
        <li>投资返现红包使用规则：在投资时勾选使用红包才能生效；投资返现红包在满足最低投资期限和最低投资金额时才可使用：待投资成功后返现金额实时发放到账户余额；</li>
        <li>新手项目仅限新用户在中再融平台上的首次投资；</li>
        <li>本次活动最终解释权归中再融所有。如有疑问，
            <p>请致电客服专线：4001-156-157</p>
        </li>
    </ol>
</div>
<!--登录注册弹窗-->
<div class="verify" style="display:none;">
    ...
    <ul>
        ...
        <li>
            ...
            <img id="img_code_pic" src="/userInfo/getCode.do" alt="图片验证码">
        </li>
        <li>
            <i class="phoneCode"></i>
        ...
        <li>
            ...
            <input id="u_id" class="txt" type="hidden" value="">
        </li>
    </ul>
    <div class="goReg">
...
<input type="hidden" id="yqm" value="${invitationCode}">
<input type="hidden" id="mobile" value="${mobile}">
<script src="<%=request.getContextPath()%>/resources/js/common/jquery-1.8.3.min.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/resources/js/common/fastclick.js" type="text/javascript"></script>
<script>
...
<script src="<%=request.getContextPath()%>/resources/js/common/swiper.min.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/resources/js/activity/invitation/invitationLoan.js${verCode }" type="text/javascript"></script>
</body>
</html>