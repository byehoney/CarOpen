...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/phone_activity.css${verCode }">
<script>
...
<div class="declaration-page">
	<div style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;overflow:auto;-webkit-overflow-scrolling : touch;">
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_01.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_02.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_03.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_04.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_05.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_06.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_07.png" alt=""/>
		<div class="September-channel-one">
			<div class="information">
				<input class="phnum txt" type="text" placeholder="请输入您的手机号" maxlength="11">
		...
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_09.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_10.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_11.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_12.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_13.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_14.png" alt=""/>
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_15.png" alt=""/>
		<div class="September-channel-two">
			<div class="ex_popupTOp">
				<p class="hot-line">客服热线</p>
		...
		<img src="<%=request.getContextPath()%>/resources/image/activity/phone_activity/September_channel_17.png" alt=""/>
	</div>
	<!--弹窗-->
	<div class="verify">
