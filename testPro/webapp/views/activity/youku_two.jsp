...
<div class="declaration_page">
    ...
    <img class="youku_one" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_one.png" alt="">
    <img class="youku_two" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_two.png" alt="">
    <img class="youku_three" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_three.png" alt="">
    <img class="youku_four" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_four.png" alt="">
    <img class="youku_five" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_five.png" alt="">
    <img class="youku_six" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_six.png" alt="">
    ...
    <div class="regulation" style="display:none;">
        ...
        <div class="details">
            ...
            <div class="rulesCont">
                <span>4、</span>
                <p>注册赠送的999元红包为投资返现红包，投资后即可兑现；</p>
            </div>
            <div class="rulesCont">
                <span>5、</span>
                <p>活动奖励分为三档，具体如下：</p>
            ...
            <div class="rulesCont">
                <span>7、</span>
                <p>活动日期：2018年01月11日至2018年01月15日；</p>
            </div>
            <div class="rulesCont">
                <span>8、</span>
                <p>本活动的最终解释权归中再融所有；</p>
