...
<script src="<%=request.getContextPath()%>/resources/js/activity/cibn.js${verCode }"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/common/css_reset.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/channel/cibn.css">
<script>
...
<section class="docWrapper">
	<div class="bannerImg"><img src="<%=request.getContextPath()%>/resources/image/activity/cibn/banner.png" alt=""></div>
	<div class="contents">
		<h3 class="title titleOne"></h3>
		<div class="investCont">
			<ul class="investList">
				...
				<li>
					<h3>1000元≤首投金额＜5000元</h3>
					<p>4个月CIBN手机会员</p>
				</li>
				<li>
					<h3>5000元≤首投金额＜10000元</h3>
					<p>6个月CIBN手机会员</p>
				</li>
				<li>
					<h3>首投金额≥10000元</h3>
			...
			<p class="prop">在本页面注册的新用户可享受以上福利</p>
		</div>
		<div class="alipayBg ali01">
			...
			<p class="information">中再融承诺不会在任何情况下泄露您的个人信息</p>
		</div>
		<h3 class="title titleTwo"></h3>
		<div class="aboutUs">
			<ul class="clearfix aboutUsList">
				<li>
					<div class="imgHeigh">
						<img src="<%=request.getContextPath()%>/resources/image/activity/cibn/icon_1.png" alt="">
					</div>
					<h3>国资背景</h3>
					<p class="largeLetters nowrap">中再生协会指定</p>
					<p class="largeLetters nowrap">互联网金融平台</p>
				</li>
				<li>
					<div class="imgHeigh">
						<img src="<%=request.getContextPath()%>/resources/image/activity/cibn/icon_2.png" alt="">
					</div>
					<h3>资金安全</h3>
					<p class="largeLetters nowrap">签约太平洋保险</p>
					<p class="largeLetters nowrap">投资更有保障</p>

				</li>
				<li>
					<div class="imgHeigh">
						<img src="<%=request.getContextPath()%>/resources/image/activity/cibn/icon_3.png" alt="">
					</div>
					<h3>灵活便捷</h3>
					<p class="largeLetters nowrap">app随时理财</p>
					<p class="largeLetters nowrap">T+1快速提现</p>
				</li>
			</ul>
		</div>
		<h3 class="title titleThree"></h3>
		<div class="giftDiv">
			<div class="fl contOne">
				<h3>新人福利</h3>
				<p class="marginP"><span>999</span>元红包</p>
				<p>注册即送</p>

			</div>
			<div class="fl contTwo">
				<h3>新用户专享项目</h3>
				<div class="fl giftRight">
					<p class="marginP"><span>12</span>%</p>
					<p>年化收益率</p>
				</div>
				<div class="fl giftRight">
					<p class="marginP"><span>30</span>天</p>
					<p>项目期限</p>
				</div>
			</div>
		...
		<div class="activeRule">
			<h3>活动规则</h3>
			<p><span class="numBox">1.</span><span class="wordBox">用户注册中再融平台，即可获得999元理财红包奖励，投资后即可兑现；活动期间投资，更有CIBN手机电视倾情助力VIP会员送不停，名额有限先到先得。</span></p>
			<p><span class="numBox">2.</span><span class="wordBox">特别说明：</span></p>
			<p class="indent"><span class="numBox numWidth">①</span> <span class="wordBox wordWidth">每个用户仅能参与一次（同一手机号、身份证号、CIBN账号、支付宝号、银行账号均视为同一用户）；</span></p>
			<p class="indent"><span class="numBox numWidth">②</span> <span class="wordBox wordWidth">实名认证与首次投资奖励可叠加；（即新注册中再融平台用户完成实名认证且完成首次投资者，可获得实名认证奖励与相对应的投资金额奖励）用户可自行登录您的CIBN账号进行查看。</span></p>
			<%--<p class="indent"><span class="numBox numWidth">③</span> <span class="wordBox wordWidth">活动期限：即日起至2017年12月31日。</span></p>--%>
			<p><span class="numBox">3.</span><span class="wordBox">中再融理财专线：4001-156-157。</span></p>
			<p><span class="numBox">4.</span><span class="wordBox">特别说明：恶意实名行为，一经发现取消所有奖励。</span></p>
			<p><span class="numBox">5.</span><span class="wordBox">活动最终解释权归中再融所有。</span></p>
			<p><span class="numBox">6.</span><span class="wordBox">网贷项目由中再融提供，CIBN手机电视不对用户的交易行为承担任何法律责任。</span></p>
		</div>
	</div>
	<div class="footer">
		<p class="phones"><span>客服热线</span>4001-156-157</p>
		<p class="companyName">中再融(北京)科技有限公司版权所有</p>
...
<input id="xkUserId" type="hidden" value="${xkUserId}">
<input id="bgcolor" type="hidden" value="ff5400">
</body>
</html>