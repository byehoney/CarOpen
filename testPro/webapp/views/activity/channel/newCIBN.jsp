...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/channel/newCIBN.css${verCode }">
    <script>
...
<script src="<%=request.getContextPath()%>/resources/js/activity/channel/newCIBN.js${verCode }" type="text/javascript"></script>
</body>
</html>