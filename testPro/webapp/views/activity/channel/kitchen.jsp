...
<script src="<%=request.getContextPath()%>/resources/js/activity/kitchen.js${verCode }"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/common/css_reset.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/channel/channelPub.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/channel/kitchen.css">
<script>
...
<body>
 	<div class="alipayPage">
		...
		<!--热门活动部分-->
			<div class="hotEvents">
				<div class="alipayBg">
					<h3><span>热门活动</span></h3>
					<div class="prizeImg">
						<p>活动奖品预览  <span>|点击查看|</span></p>
					</div>
				</div>
			</div>
		<!--热门活动部分  end-->
			<div class="alipayBg ali01">
				<h3><span>注册即送999元投资红包</span></h3>
				...
				<div class="instructions">
					<div class="rulesCont">
						...
						<div>
							...
							<p>A、首次投资（新手项目）单笔1000元，送1000厨币+渔人百味（野生特级海带根）2500g礼品。</p>
							<p>B、首次投资（新手项目）单笔5000元，送5000厨币+豪鲜惠（越南进口 龙利鱼柳）1000g礼品。</p>
							<p>C、首次投资（80天≤标期≤365天）单笔5000元，送10000厨币+炊大皇24cm（麦板石牛排扒盘）礼品。</p>
							<p>（A、B、C投资奖励三选一）</p>
						</div>
					</div>
					<div class="rulesCont">
						<span>2</span>
						<div>
							<p>用户成功参与活动后7个工作日内，网上厨房会将对应的厨币充值到用户对应网上厨房手机账户中并邮寄对应的礼品（用户一定要在网上厨房后台里填写地址信息）。</p>
						</div>
					</div>
					<div class="rulesCont">
						<span>3</span>
						<div>
							<p>活动仅限通过网上厨房活动页面注册参与，不与中再融理财平台内其它活动重叠参与。</p>
						</div>
					</div>
					<div class="rulesCont">
						<span>4</span>
		...
		<div class="rewardPopup">
			...
			<div class="InviteCont">
				<div class="rewardList">
					<span class="physical">实物奖励</span>
					<span class="currency">厨币奖励</span>
					<span class="requirements">投资要求</span>
				</div>
				<ul class="trophyList">
					<li>
						<div class="physical"><p>渔人百味</p><p class="moreover">野生特级海带根</p></div>
						<span class="currency">1000厨币</span>
						<span class="requirements"><em>￥1000</em>新手项目</span>
					</li>
					<li>
						<div class="physical"><p>豪鲜惠</p><p class="moreover">越南进口龙利鱼柳</p></div>
						<span class="currency">5000厨币</span>
						<span class="requirements"><em>￥5000</em>新手项目</span>
					</li>
					<li>
						<div class="physical"><p>炊大皇</p><p class="moreover">麦板石牛排扒盘</p></div>
						<span class="currency">10000厨币</span>
						<span class="requirements"><em>￥5000</em>标期≥80天</span>
					</li>
				</ul>
			</div>
		</div>
