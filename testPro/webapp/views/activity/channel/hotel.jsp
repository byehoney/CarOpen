...
<script src="<%=request.getContextPath()%>/resources/js/activity/channel.js${verCode }"></script>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/channel/hotel.css">
<script>
...
<body>
 	<div class="alipayPage">
		<div class="docWrapper">
				...
				<ul class="instructions">
					<li>
						...
						<div>
							...
							<p>A、首次投资任意项目（含新手标）单笔1000元，赠送100元优惠券。</p>
							<p>B、首次投资任意项目（含新手标）单笔5000元，赠送200元优惠券。</p>
							<p>C、首次投资80天以上标期项目单笔5000元，赠送400元优惠券。</p>
							<p>（A、B、C投资奖励四选一）</p>
						</div>
					</li>
					<li>
						<span>2</span>
						<div>
							<p>用户成功参与活动后，可凭中再融APP内“我的-投资记录”及注册手机号在酒店前台获得奖励；</p>
						</div>
					</li>
					<li>
						<span>3</span>
						<div>
							<p>活动仅限通过本酒店活动页面注册参与，不与中再融理财平台内其它活动重叠参与；</p>
						</div>
					</li>
					<li>
						<span>4</span>
						<div>
							<p>平台如发现作弊或恶意获取奖励行为者，将直接取消活动资格；</p>
						</div>
					</li>
					<li>
						<span>5</span>
			...
			<div class="alipayBg">
				<h3><span>新用户专享</span></h3>
				<div class="treasure">
					<div class="changeColor"><span>15</span>%</div>
					<p>预计年化收益率</p>
				</div>
		...
		<input id="bgcolor" type="hidden" value="07a373">
	</div>
</body>
</html>