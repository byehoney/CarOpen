...
<%
    ...
    String cheerMoney = request.getParameter("cheerMoney");
...
%>
	<div class="main">
		<nav>
			...
			<p class="loginText">登录中再融，立即提现吧！</p>
		</nav>
		<ul class="loginBox">
			<li>
				<input type="hidden" value="${result.data.refPath}" id="refPath">
				<input type="hidden" value="<%= sign%>" id="sign">
				<input type="hidden" value="<%= cheerMoney%>" id="cheerMoney">
				<input type="hidden" value="<%=wxUserGameId %>" id="wxUserGameId">
				<input id="pasPasword" class="pasInput borRadian" name="" type="password" placeholder="密码（没有密码？请前往官网设置）" maxlength="16" />
			</li>
			<li>
