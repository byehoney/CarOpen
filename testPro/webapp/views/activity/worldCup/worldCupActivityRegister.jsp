...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/worldCup/worldCupRegister.css${verCode }">
    <script>
...
<body>
<div class="June_page docWrapper">
    <div class="banner">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_01.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_02.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_03.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_04.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_05.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_06.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_07.png" alt="">
        <img src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/banner_08.png" alt="">
    </div>
    <div class="distance">
        <div class="fri_info">
            <p>好友<em>${mobile}</em>送您<span>999元</span>理财红包</p>
        </div>
        <!--登录领取-->
        <div class="alipayBg mt50">
            ...
            <div class="ex_popup"><a id="popup01" href="javascript:;">领取999元红包</a></div>
            <p class="information">中再融承诺不会在任何情况下泄露您的信息</p>
        </div>

        <div class="earnings_cont">
            <img class="base_person" src="<%=request.getContextPath()%>/resources/image/activity/worldCup/register/base_person.png" alt="">
            <h3 class="earnings_title">为什么选择中再融</h3>
            <div class="alipayBg mt">
                <ul class="picList">
                    <li>
                        <div class="units_ioc"></div>
                        <div class="copywritingTip fr">
                            <h4>国资背景</h4>
...
<div class="verify" style="display:none;">
    ...
    <ul>
        <li>
            ...
            <input id="mobile_num" class="txt" type="text" name="username" placeholder="请输入您的手机号码" maxlength="11">
        </li>
        <li>
            <i class="refreshIcon"></i>
            <input id="img_code" class="verificationCode" type="text" name="username" placeholder="请输入图片中的字符" maxlength="11">
        ...
        <li>
            ...
            <input id="password" class="txt" type="password" name="username" placeholder="请输入6-16位字符密码" maxlength="11">
            <input id="u_id" class="txt" type="hidden" value="">
        </li>
    </ul>
    <div class="ex_popup goReg" id="go_reg">
        <a href="javascript:;">领取999元红包</a>
    </div>
</div>
...
<input type="hidden" id="yqm" value="${yqm}">
...
<script src="<%=request.getContextPath()%>/resources/js/activity/worldCup/worldCupRegister.js${verCode }" type="text/javascript"></script>
</body>
</html>