...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/worldCup/worldCupRegister.css">
    <!--PC百度统计代码-->
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="June_page">
    <div class="distance">
        <div class="pop_box">
            ...
            <div class="succeed_title">注册成功，恭喜您，成功获取999元红包</div>
        </div>
    </div>
    <div class="ex_popup employ_btn loadbtn">
