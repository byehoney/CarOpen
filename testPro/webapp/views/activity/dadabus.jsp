...
<script src="<%=request.getContextPath()%>/resources/js/activity/dadabus.js${verCode }"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/common/css_reset.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/dadabus.css${verCode }">
<script>
		...
		<div class="docWrapper">
			...
			<div class="alipayBg">
				...
				<div class="instructions">
					<p>1、活动奖励适用于首次投资单笔满1000元，且标期≥25天(含新手标)的用户；</p>
					<p>2、嗒嗒代金券领取：用户满足相应条件后三个工作日内由嗒嗒巴士以手机短信形式发送至用户注册手机号码，请注意查收； </p>
					<p>3、平台现金券领取：用户可在“我的-红包”中查看红包详情，不可直接提现；</p>
					<p>4、嗒嗒代金券可用于乘坐嗒嗒巴士支付使用，不可提现；</p>
					<p>5、平台如发现作弊或恶意获取奖励行为者，将直接取消活动资格；</p>
					<p>6、本活动最终解释权归中再融所有，详情请咨询4001-156-157</p>
					<p>Ps：中再融友情提示：嗒嗒巴士现金券自兑换之日起60日内有效，请注意不要过期哦~</p>
				</div>
			</div>
			<div class="alipayBg">
