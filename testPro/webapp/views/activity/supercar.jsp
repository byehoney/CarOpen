...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/supercar.css${verCode }">
<script>
...
<body>
 	<div class="declaration-page">
		...
		<img class="car-superman-one" src="<%=request.getContextPath()%>/resources/image/activity/supercar/car-superman_01.png" alt=""/>
		<img class="car-superman-two" src="<%=request.getContextPath()%>/resources/image/activity/supercar/car-superman_02.png" alt=""/>
		<img class="car-superman-three" src="<%=request.getContextPath()%>/resources/image/activity/supercar/car-superman_03.png" alt=""/>		
		...
		<div class="car-superman-five">
			<ul class="picList clearfix">
				...
				<li>
					...
					<p>灵活便捷</p>
					<p class="largeLetters">手机app随时理财,T+1快速提现</p>
				</li>
			</ul>
		</div>
		<img class="car-superman-six" src="<%=request.getContextPath()%>/resources/image/activity/supercar/car-superman_06.png" alt=""/>
		<div class="car-superman-seven">
		...
		<div class="regulation" style="display:none;">
				...
				<div class="details">
					...
					<div class="rulesCont">
						<span>1、</span>
						<p>活动期间，通过本活动页面首次注册并投资相应项目，即送洗车券，活动奖励不叠加；</p>
					</div>
					<div class="rulesCont">
						<span>2、</span>
						<p>满足活动条件后，洗车券将以短信兑换码形式发送，于五个工作日内发送至您注册中再融手机号码，请注意查收，本卡金额不能兑换现金、不记名、不挂失；</p>
					</div>
					<div class="rulesCont">
						<span>3、</span>
						<p>兑换流程：下载汽车超人APP并注册，用户在卡/钱包里完成兑换、使用，自动抵扣支付所需费用；</p>
					</div>
					<div class="rulesCont">
						<span>4、</span>
						<p>注意事项：</p>
					...
					<div class="rulesCont">
						<span>C、</span>
						<p>春节期间因合作门店休息，券码暂停使用；</p>
					</div>
					<div class="rulesCont">
						<span>D、</span>
						<p>如有疑问详询汽车超人官方客服热线：</p>
						<p>400-699-0000；</p>
					</div>
					<div class="rulesCont">
						<span>E、</span>
						<p>券码有效期 2017.9.1-2017.12.31 兑换后180天有效；</p>
					</div>
					<div class="rulesCont">
						<span>5、</span>
			...
			<input id="bgcolor" type="hidden" value="ffc000">	
