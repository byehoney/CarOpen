...
<script src="${basePath}/resources/js/activity/werwolfdone.js${verCode }"></script>
<link rel="stylesheet" href="${basePath}/resources/css/activity/newwerwolfdone.css${verCode }">
<!--PC百度统计代码-->
<script>
	var _hmt = _hmt || [];
	(function() {
...
<body>
 <div class="page">
    ...
    <div class="con">
        ...
        <c:if test="${loanId != 0}">
            <a class="btn" href="${basePath}/loan/detail/${loanId}.do"></a>
        </c:if>
        <c:if test="${loanId == 0}">
            <a class="btn" href="${basePath}/loan/list.do"></a>
        </c:if>
