...
<title>中再融，牵手优酷联合送福利</title>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/common/css_reset.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/youku.css">
...
<script src="<%=request.getContextPath()%>/resources/js/activity/youku.js"></script>
<script>
...
<div class="declaration_page">
    <input id="member" type="hidden" value="<%=request.getAttribute("member")%>">
    <div class="docWrapper">
    <img class="youku_channel_one" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_channel_one.png" alt="">
    <img class="youku_channel_two" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_channel_two.png" alt="">
    <img class="youku_channel_three" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_channel_three.png" alt="">
    <img class="youku_channel_four" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_channel_four.png" alt="">
    <img class="youku_channel_five" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_channel_five.png" alt="">
    <img class="youku_channel_six" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_channel_six.png" alt="">
    <div class="youku_seven">
        <div class="information">
            <input class="phnum txt" type="text" placeholder="请输入手机号" maxlength="11">
            ...
            <div class="goReg">
                <a id="popup01" href="javascript:;">立即注册</a>
            </div>
        </div>
    ...
    <img class="youku_eight" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_eight.png" alt="">
    <img class="youku_nine" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_nine.png" alt="">
    <img class="youku_ten" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_ten.png" alt="">
    <img class="youku_eleven" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_eleven.png" alt="">
    <img class="youku_twelve" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_twelve.png" alt="">
    <img class="youku_thirteen" src="<%=request.getContextPath()%>/resources/image/activity/youku/youku_thirteen.png" alt="">
    <div class="youku_fourteen">
    ...
    <div class="regulation" style="display:none;">
        ...
        <div class="details">
            ...
            <div class="rulesCont">
                <span>1、</span>
                <p>只有在本页面注册才可以获得优酷奖励；</p>
            </div>
            <div class="rulesCont">
                <span>2、</span>
                <p>活动页面注册手机号需与优酷会员手机号一致；</p>
            </div>
            <div class="rulesCont">
                <span>3、</span>
                <p>每个用户（同一手机号、身份证号、优酷账号、支付宝号、银行账号均视为同一用户）仅能参与一次；</p>
            </div>
            <div class="rulesCont">
                <span>4、</span>
                <p>注册即送一个月优酷VIP黄金会员及999元红包，赠送的999元红包为投资返现红包，投资后即可兑现；</p>
            </div>
            <div class="rulesCont">
                <span>5、</span>
                <p>活动奖励分为三档，具体如下：</p>
            ...
            <div class="rulesCont">
                <span>A、</span>
                <p>首次投资（任意项目）满2000元，赠送2个月优酷VIP黄金会员；</p>
            </div>
            <div class="rulesCont">
                <span>B、</span>
                <p>首次投资（任意项目）满5000元，赠送6个月优酷VIP黄金会员；</p>
            </div>
            <div class="rulesCont">
                <span>C、</span>
                <p>首次投资（80天≤标期≤365天）满8000元，赠送一年优酷VIP黄金会员；</p>
            </div>
            <div class="rulesCont">
                <span>6、</span>
                <p>用户成功参与活动后，奖励将自动发放至优酷账号内；</p>
            </div>
            <div class="rulesCont">
                <span>7、</span>
                <p>活动日期：2018年01月13日至2018年01月22日；</p>
            </div>
            <div class="rulesCont">
                <span>8、</span>
                <p>本活动的最终解释权归中再融所有；</p>
            ...
            <div class="rulesCont">
                <span>9、</span>
                <p>网贷项目由中再融提供，优酷不对用户的交易行为承担任何法律责任；</p>
            </div>
            <div class="rulesCont">
                <span>10、</span>
                <p>中再融客服热线：4001-156-157</p>
            </div>
        </div>
    </div>
    <div class="overlay" style="display:none;"></div>
    <div class="errormsg"></div>
    <input id="bgcolor" type="hidden" value="846019">
