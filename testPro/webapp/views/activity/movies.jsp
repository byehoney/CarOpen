...
<script src="<%=request.getContextPath()%>/resources/js/activity/supercar.js${verCode }"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/common/css_reset.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/activity/movies.css${verCode }">
<script>
...
<body>
<section class="declaration-page">
	<img class="purchase-one" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-001.png" alt=""/>
	<img class="purchase-seven" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-002.png" alt=""/>
	<img class="purchase-eight" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-003.png" alt=""/>
	<img class="purchase-nine" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-004.png" alt=""/>
	<img class="purchase-ten" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-005.png" alt=""/>
	<img class="purchase-eleven" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-006.png" alt=""/>
	<img class="purchase-three" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-007.png" alt=""/>
	<img class="purchase-twelve" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-008.png" alt=""/>
	<img class="purchase-thirteen" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-009.png" alt=""/>
	<div class="purchase-four">
		<div class="activity-pic">查看活动规则</div>
		<div class="errormsg"></div>
		<div class="err01"></div>
		<div class="information">
			<div class="register">
				<input class="txt phnum"  type="text" placeholder="请输入手机号" maxlength="11"/>
				...
				<div class="goReg">
					<a href="javascript:;" id="popup01">立即注册</a>
				</div>
	...
	<img class="purchase-five" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-010.png" alt=""/>
	<img class="purchase-fourteen" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-011.png" alt=""/>
	<img class="purchase-fifteen" src="<%=request.getContextPath()%>/resources/image/activity/movies/purchase-012.png" alt=""/>
	<div class="purchase-six" style="display:n-one">
		<div class="cooperation"></div>
		<div class="ex_popupTOp">
			<p class="phone">客服热线</p>
			<p class="phone">4001-156-157</p>
			<p>中再融(北京)科技有限公司版权所有</p>
			<p>京ICP备16002418号-1 </p>
			<p class="reminding">理财有风险 投资需谨慎</p>
		</div>
	</div>
	...
	<div class="verify" style="display:none;">
		...
		<ul>
			<li>
				...
				<input class="txt" id="mobile_num"  type="text" name="username" placeholder="请输入您的手机号码" maxlength="11">
			</li>
			<li>
			...
			<li>
				<i class="phoneCode"></i>
				<input id="msg_code" class="verificationCode" type="text" name="username" placeholder="请输入手机验证码" maxlength="6">
				<span class="pop_msg_count">发送验证码</span>
			</li>
			<li>
				<i class="passwordIcon"></i>
				<input id="password" class="txt" type="text" name="username" placeholder="请输入6-16位字符密码 （选填）" maxlength="11">
			</li>
		</ul>
	...
	<div class="regulation" style="display:none;">
		...
		<div class="details">
			...
			<div class="rulesCont">
				<span>1、</span>
				<p>通过本活动页面注册中再融，首次投资A、B、C三档理财产品：</p>
			</div>
			<div class="rulesCont">
				<span>A、</span>
				<p>首次投资（新手项目）单笔3000元，赠送两张电影票</p>
			</div>
			<div class="rulesCont">
				<span>B、</span>
				<p>首次投资（新手项目）单笔10000元，赠送四张电影票</p>
			</div>
			<div class="rulesCont">
				<span>C、</span>
				<p>首次投资（56天≤标期≤365天）单笔10000元，赠送六张电影票</p>
			</div>
			<div class="rulesCont">
				<span>2、</span>
				<p>用户成功参与活动后3个工作日内，爱购影豆将会以短信形式发送到用户对应手机号码中；</p>
			</div>
			<div class="rulesCont">
				<span>3、</span>
				<p>活动仅限通过爱购影豆活动页面注册参与，不与中再融理财平台内其它活动重叠参与；</p>
			</div>
			<div class="rulesCont">
				<span>4、</span>
				<p>本活动的最终解释权归中再融所有；</p>
	...
	<div class="xyjsp serve" style="display:none">
	...
	<div class="xyjsp secret" style="display:none">
		<div class="close-btn"></div>
		<h3>中再融隐私条款</h3>
		<div class="xycont">
