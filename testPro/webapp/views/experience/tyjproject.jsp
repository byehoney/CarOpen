...
<body>
<div class="tyjproject">
	<div class="apptyj">
	   <div class="earnings">
	      <span>体验金收益(元)</span><p class="openguize">活动规则></p>
	   </div>
	   <div class="money">30.00</div>
	   <div class="money_tyj"><span>我的体验金(元)</span><p>100,000.00</p></div>
	</div>
	<div class="app_go">
	   <p class="jh">体验金专享理财计划</p>
	   <ul>
	      <li>
	          <span>10.9%</span>
	          <p>年化收益</p>
	...
	<c:if test="${experienceStatus == 1}">
		<div class="getmoney"><a href="<%=request.getContextPath() %>/activeEarnings.do">激活收益</a></div>
	</c:if>
	<c:if test="${experienceStatus == 2}">
		<div class="getmoney"><a class="gray" href="javascript:;">计息中，明天来领吧...</a></div>
	</c:if>
	<c:if test="${experienceStatus == 3}">
		<div class="getmoney"><a href="javascript:;" class="experienceBtn">领取收益</a></div>
	</c:if>
	<div class="slider"><%-- <img src="<%=request.getContextPath() %>/resources/image/app/apptyj/apptyj_1.png" alt="" width="40"><p>继续拖动，赚更多 ∧</p> --%></div> 
</div>
...
<c:if test="${experienceStatus == 1 || experienceStatus == 2}">
	<div class="app_invit">
		<img src="<%=request.getContextPath() %>/resources/image/app/apptyj/apptyj_8.jpg" alt="">
		<img src="<%=request.getContextPath() %>/resources/image/app/apptyj/apptyj_9.jpg" alt="">
		<img src="<%=request.getContextPath() %>/resources/image/app/apptyj/apptyj_10.jpg" alt="">
	</div>
</c:if>
<div class="wx_guize">
	   <div class="top">
...
<script type="text/javascript">
	// 领取十万体验金
	$(".experienceBtn").bind("click",incomeExperienceGold);
	function incomeExperienceGold(){
		$(".experienceBtn").unbind("click",incomeExperienceGold);
		$(".experienceBtn").css({"background":"#ebebeb","color":"#d2d1d1"});
		$.ajax({
	        url : "<%=request.getContextPath()%>/drawExperienceRedPackedJson.do",
	        dataType :'json',
	        type : 'post',
	 ...
	 <!--领取收益失败,请联系客服!-->
 <div class="yinker_mx newstyle" id="fail"   style="display: none;">
    <h2>温馨提示<span onclick="closeJWin('fail'); window.location.reload();"></span></h2>
    <div>
    <p style="margin-bottom:10px;">领取收益失败，请联系客服！</p>
    </div>
 </div>
 <!-- 分享弹出框 -->
 <div id="share">
 <p class="shareTitle">领取收益<i class="cross" onclick="closeJWin('share',reload);"></i></p>
	 <div class="shareNotice">
	 	<div class="shareNoticeDiv">
		 	 <div class="shareNoticeDivDiv"><img alt="" src="<%=request.getContextPath()%>/resources/image/jwin/shareNoticebg.png"></div>
			 <p>恭喜</p>
			 <p>您已成功领取收益<span class="redmoney">30</span>元</p>
	 	</div>
	 	 
	 </div>
	 <div class="shareBox" style="height:60px">
	 	<p>赶紧分享给你的小伙伴让更多人免费领收益吧！</p>
	 	<p>越多分享、越多参与、越高回报！</p>
	 	
	 	
<!-- <div class="bdsharebuttonbox"><span>分享到： </span><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_tieba" data-cmd="tieba" title="分享到百度贴吧"></a><a href="#" class="bds_more" data-cmd="more"></a></div>
 -->
<script>
//window._bd_share_config={"common":{"bdSnsKey":{"tqq":"key"},"bdText":"中再融：我出10万本金，利息归你！100亿体验金派送，和好友一起抢！越多人抢、收益越高！","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"32"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
$("#share a:lt(5):gt(0)").click(function(){
	closeJWin("share",reload);
})
$(document).on("click",function(ev){
	var ev = ev||event;
	var target = ev.target || ev.srcElement;
	target = $(target)
	if(target[0].nodeName.toLowerCase() == "a"&&target.parent().parent(".bdshare_dialog_list").length>0||target[0].nodeName.toLowerCase() == "a"&&target.parent(".bd_weixin_popup_head").length>0){
		closeJWin("share",reload);
