...
<%--             <span class="clear_icon"><img src="${basePath}/resources/image/clear_icon.png" alt="success"></span> --%>
        ...
        <div class="login_btn bg1" id="login_btn">登录</div>
        <div class="forget_box"><a class="forget_pasd" href="javascript:;">忘记密码？</a></div>
        <div class="registration_btn bg2"><a href="${basePath}/register/toRegister.do">立即注册</a></div>
...
function login() {
        ...
        var url = "${basePath}/userInfo/userlogin.do";
        $.post(url, {
                    "nickname": nkName,
                    "password": $.md5(pwd),
